...
This version includes source code and Batch mode so you can combine several objects materials easily.
...
Reuse Textures: [Check box] If checked if there are repeated textures they will be remapped and only be used once
