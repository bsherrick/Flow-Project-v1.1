...
public class GameFlowFramework_GameCamera : MonoBehaviour
{
    //Default Values
    /****************************************************************************/
    //2D Cam
    ...
    void Start()
    {
        ...
        target = referencer.GameFlowFramework_PlayerCharacter.playerObject.transform; //get the player character's location
